...
with col[1]:
        ...
        with st.expander('เกี่ยวกับ', expanded = True):
            st.write('''
                        - 🏛️ข้อมูลจากคลังข้อมูลการแพทย์และสุขภาพ (HDC) กรมสุขภาพจิต กระทรวงสาธารณสุข
                        - 🔗https://dmh.go.th/report/datacenter/hdc/
                        - 📍geojson: https://github.com/chingchai/OpenGISData-Thailand/blob/7f4c885f9c90599550a51c4d8c4fd7f259eab18b/provinces.geojson
