...
## 🏛️ Data Sources
- Health Data Center (HDC), Department of Mental Health  
  🔗 https://dmh.go.th/report/datacenter/hdc/
- GeoJSON boundaries from OpenGISData-Thailand  
  📍 https://github.com/chingchai/OpenGISData-Thailand/blob/main/provinces.geojson
...
## 🚫 Scope Limitations
- ❌ No exploratory data analysis (EDA)  
- ❌ No outlier detection or statistical modeling  
- ✅ Focused on clean presentation and interactive storytelling

## 🛠️ Tools & Technologies
- Python, Pandas, Streamlit  
- GeoJSON for spatial mapping  
- Custom modular functions for data cleaning and merging
